...
get_header(); ?>
    ...
    <section class="tos-body">
        ...
        <!-- 1 — open by default -->
                <div class="tos-section is-open">
                    <h2>1. Privacy Policy</h2>
                    <div class="tos-section-body">
                        <p>
                            At Belgravia Imports, accessible from belgraviaimports.com, one of our main priorities is
                            the
                            privacy of our visitors. This Privacy Policy document contains types of information that is
                            collected and recorded by belgraviaimports.com and how we use it.
                        </p>
                ...
                <div class="tos-section">
                    ...
                    <div class="tos-section-body">
                        ...
                        <p>When you register for an Account, we may ask for your contact information, including items
                            such
                            as name, Belgravia Imports, address, email address, and telephone number.</p>
                    </div>
                </div>
                ...
                <div class="tos-section">
                    ...
                    <div class="tos-section-body">
                        <p>
                            belgraviaimports.com follows a standard procedure of using log files. These files log
                            visitors
                ...
                <div class="tos-section">
                    ...
                    <div class="tos-section-body">
                        <p>
                            Like any other website, belgraviaimports.com uses 'cookies'. These cookies are used to store
                ...
                <div class="tos-section">
                    ...
                    <div class="tos-section-body">
                        ...
                        <p>
                            ...
                            belgraviaimports.com,
                            which are sent directly to users' browsers. They automatically receive your IP address when
                            this
                        ...
                        <p>
                            Note that belgraviaimports.com has no access to or control over these cookies that are used
                            by
                ...
                <div class="tos-section">
                    ...
                    <div class="tos-section-body">
                        <p>
                            belgraviaimports.com's Privacy Policy does not apply to other advertisers or websites. Thus,
                            we
                ...
                <div class="tos-section">
                    ...
                    <div class="tos-section-body">
                        ...
                        <p>The right to rectification – You have the right to request that we correct any information
                            you
                            believe is inaccurate. You also have the right to request that we complete the information
                            you
                ...
                <div class="tos-section">
                    ...
                    <div class="tos-section-body">
                        <p>Another part of our priority is adding protection for children while using the internet. We
                            ...
                            online activity.</p>
                        <p>belgraviaimports.com does not knowingly collect any Personal Identifiable Information from
    ...
    <!-- Contact Band (same style as Terms page) -->
    <section class="tos-contact">
        <div class="container">
            <div class="inner-box">
                <h2>Questions About Your Data?</h2>
                <p>Our team is happy to clarify how your information is collected and used.</p>
                <div class="contact-details">
                    <a href="tel:4016833323">401.683.3323</a><br>
                    <a href="mailto:belgravia@belgraviaimports.com">belgravia@belgraviaimports.com</a>
                </div>
                <a href="mailto:belgravia@belgraviaimports.com" class="cta-btn">Contact Us</a>
            </div>
        </div>
    </section>
